...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( SplashStatus status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SplashState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( SplashStatus status)  $default,) {final _that = this;
switch (_that) {
case _SplashState():
return $default(_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( SplashStatus status)?  $default,) {final _that = this;
switch (_that) {
case _SplashState() when $default != null:
return $default(_that.status);case _:
  return null;
...
class _SplashState implements SplashState {
  const _SplashState({this.status = SplashStatus.loading});
